...
```json
{
  "usercentrics": {
    ...
    "shadowDom": true,
    "learnedAt": "2024-01-15T10:00:00.000Z",
    "learnedFrom": "https://example.com"
  }
}
```
...
**Ablauf:**
1. **CMP-Erkennung** – Prüft alle Selektoren aus `cmp-library.json` gegen die lebende Seite. Bei Treffer: automatisch verwenden. Kein Treffer: Exit mit Hinweis auf `learn.js`. `--cmp` überspringt die Erkennung.
...
5. **Post-Reject** – Komplett neuer Browser, Startseite, Reject klicken, Diffs erfassen. Kein E-Commerce-Pfad nach Reject.
